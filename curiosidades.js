const perguntas = [
  {
  // pergunta 1(td junto)
  pergunta: "Qual é o planeta do sistema solar que gira mais rápido em torno de seu eixo?",
  opcoes: [
    "Marte",
    "Terra",
    "Mercúrio",
...
{
  // pergunta 2(td junto)
  pergunta: "Qual país tem o maior número de fusos horários no mundo, incluindo territórios ultramarinos?",
  opcoes: [
    "Rússia",
    "EUA",
    "China",
...
{
  // pergunta 3(td junto)
  pergunta: "Quantas letras tem a maior palavra registrada na língua portuguesa?",
  opcoes: [
    "41",
    "42",
    "43",
...
{
  // pergunta 4(td junto)
  pergunta: "Em que ano o cinema foi fundado e quem inventou?",
  opcoes: [
    "1900, por Thomas Edison",
    "1895, por irmãos Lumière",
    "1888, por Georges Méliès",
    "1890, por Louis Daguerre"
  ],
  correta: 1
},
{
  // pergunta 5(td junto)
  pergunta: "Qual foi o primeiro país a adotar o horário de verão no mundo?",
  opcoes: [
    "Nova Zelândia",
    "Brasil",
    "Estados Unidos",
...
{
  // pergunta 6(td junto)
  pergunta: "Qual é o objeto mais antigo feito pelo homem que se tem registro?",
  opcoes: [
    "Cerâmica",
    "Faca de pedra",
    "Pedra lascada",
...
{
  // pergunta 7(td junto)
  pergunta: "Qual fenômeno atmosférico é formado por ventos que giram em alta velocidade, criando uma coluna em forma de funil?",
  opcoes: [
    "Furacão",
    "Tornado",
    "Ciclone",
...
{
  // pergunta 8(td junto)
  pergunta: "Qual vulcão é considerado o mais ativo do mundo?",
  opcoes: [
    "Monte Fuji",
    "Kilauea",
    "Etna",
...
{
  // pergunta 9(td junto)
  pergunta: "Quantas luas conhecidas possui o planeta Saturno atualmente?",
  opcoes: [
    "50",
    "62",
    "74",
...
},
{
  ...
  pergunta: "Qual é a origem do jogo de xadrez?",
  opcoes: [
    "China",
    "Egito",
    "Índia",
...
},
{
  ...
  pergunta: "Qual é o mineral mais duro encontrado na natureza?",
  opcoes: [
    "Quartzo",
    "Ouro",
    "Rubi",
...
},
{
  ...
  pergunta: "Qual é a invenção mais antiga registrada que ajudou na medição do tempo?",
  opcoes: [
    "Relógio mecânico",
    "Clepsidra (ampulheta de água)",
    "Solário (Instrumento solar)",
    "Calendário romano"
  ],
  correta: 1
},
...
},
{
  ...
  pergunta: "Qual planeta do Sistema Solar possui o dia mais longo?",
  opcoes: [
    "Júpiter",
    "Marte",
    "Mercúrio",
